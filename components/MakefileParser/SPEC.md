...
- class ParseResult: ast(list[ASTNode]), diagnostics(list[Diagnostic]).
</data>
<functions>
  ...
  - Parses conditionals (`ifeq`, `ifneq`, `ifdef`, `ifndef`, `else`, `endif`) building nested Conditional nodes; unmatched conditional -> ERROR PARSER_CONDITIONAL.</function>
...
- No evaluation of variables; leaves expansions intact for evaluator.</contracts>
<testing>
...
- Include parsing with optional flag detection.</testing>
</component_spec>
