...
<functions>
  ...
  - Executes conditional tests using simple textual comparison; unsupported functions emit WARN EVAL_UNSUPPORTED_FUNC.</function>
...
- Conditional evaluation with ifeq/ifneq/ifdef/ifndef.
